...
> _A personalized, uncertainty-aware pipeline from genetic risk to visual experience._
...
> _Given who you are genetically and how you live, what will you see at age 50? At 65? At 80 — and with what uncertainty?_
...
visiogen/
│
├── genetics/              # Polygenic Risk Score modeling
...
│
├── progression/           # Disease progression modeling
...
│
├── simulation/            # Visual simulation pipeline
...
- Output: a continuous individual risk score _r ∈ [0, 1]_ per disease

**Anchor disease:** Age-related Macular Degeneration (AMD) — richest GWAS data, clean staging, strong genetic signal (_CFH_, _ARMS2_)
...
- Genetic risk score _r_ and GxE covariates modulate transition rates
...
_Built with curiosity. Modeled with rigor. Rendered with care._
